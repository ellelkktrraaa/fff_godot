...
## 每帧头顶偏移（head_gap）
const KNIGHT_ATTACK_HEAD: Array[int] = [72, 72, 74, 196, 154, 137, 138, 140]

## 每帧中轴水平偏移（center_dx），渲染时用于让角色内容中轴对齐碰撞体中心
const KNIGHT_ATTACK_CENTER: Array[float] = [-6.0, -6.0, 24.0, 37.0, 58.0, 55.5, 56.5, 57.5]

## 每帧内容尺寸（content_w / content_h）
const KNIGHT_ATTACK_CONTENT_W: Array[int] = [470, 470, 530, 1024, 1078, 1095, 1095, 1095]
const KNIGHT_ATTACK_CONTENT_H: Array[int] = [659, 659, 657, 523, 565, 582, 581, 579]
